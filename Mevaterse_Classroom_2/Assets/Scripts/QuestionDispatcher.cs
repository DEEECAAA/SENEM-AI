...
public class RequestData
{
    ...
    public float participation_level;
    public string audio;

    public RequestData(string subject, int personality, int intelligence, int interest, int happiness, float participationLevel, string audio)
    {
...
public class QuestionDispatcher : MonoBehaviour
{
    ...
    private IEnumerator SendAudioToServer(AudioClip audioClip, SmartStudentController studentController, Personality personality, Intelligence intelligence, Interest interest, Happiness happiness)
    {
        ...
        RequestData requestData = new RequestData(
            ...
            (int)interest,
            (int)happiness,
            SessionManager.Instance.ParticipationLevel,
