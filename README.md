...
This repository contains a new version of **SENEM-AI**, introducing improvements to the Smart Student experience and lesson management.

The main updates include:
- **Improved classroom personality selection**: the configuration of Smart Students has been enhanced to provide better control over the personalities represented in the virtual classroom.
- **Improved slide tracker**: the slide tracking system has been refined to better keep track of the presentation flow during a lesson.
- **macOS build support**: the Unity project can also be built for macOS directly from Unity.

The updated Smart Student Server used by this version is available here:  
[Smart Student Server DECA](https://github.com/DEEECAAA/Smart_Student_Server_DECA)
...
To make them work in SENEM, you will need to get the [Smart Student Server](https://github.com/DEEECAAA/Smart_Student_Server_DECA).
...
## How to Install
You can either use a pre-built version of the application or access the entire project in Unity. In either case, if you want to try out the Smart Students functionality you will need the [corresponding server](https://github.com/DEEECAAA/Smart_Student_Server_DECA) and follow the instructions there for installation.
...
The project can be opened and built from Unity for supported platforms, including **Windows and macOS**.
...
5. [Optional] Clone the Smart Students Server repository and follow [the instructions](https://github.com/DEEECAAA/Smart_Student_Server_DECA/blob/main/README.md) to install it.
