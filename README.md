...
To make them work in SENEM, you will need to get the Smart Student Server.
...
Download the file `\_MacOS Build.app\_` and extract it into a folder.
...
```bash
   ...
   * Double-click on `\_MacOS Build.app\_` to launch the application.
...
1. Download *Metaverse\_Classroom\_2*.
2. Open the Unity Hub, go in the *Projects* tab and click on the *Add* button.
3. Choose the path where you downloaded the *Metaverse\_Classroom\_2*.
